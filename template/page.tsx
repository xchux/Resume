...
import {
  ...
  awardProjectCompetitionSchemaType,
  awardProjectSchemaType,
  awardsSchemaType,
  educationSchoolSchemaType,
  workExperienceCompanySchemaType,
  profileSchemaType,
  aboutSchemaType,
  skillsSchemaType,
  projectSchemaType,
  projectProjectsSchemaType,
  translatoinDataSchemaType
} from "@/types/page";
    ...
    <>
      ...
      <div id="profile" className="flex items-center gap-x-3">
        <div className="shrink-0">
          <img className="shrink-0 size-16 rounded-full" src="/Resume/profile.jpg" alt="Avatar" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {
            educationData.schools.map((school: educationSchoolSchemaType, idx: number) => (
              <div key={idx} className="p-4 border border-gray-200 rounded-lg dark:border-neutral-700">
                <Image src={`/Resume/${school.icon}.svg`} alt="" width={20} height={20} />
        ...
        <div className="space-y-3">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            ...
            <dd>
              <ul>
                ...
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" fill="#000000" width="24" height="24" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            ...
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" fill="#000000" id="Capa_1" width="24" height="24" viewBox="0 0 548.29 548.291" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" version="1.0" width="24" height="24" viewBox="0 0 424.000000 422.000000" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            ...
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" width="24" height="24" viewBox="0 0 48 48" fill="#000000" xmlns="http://www.w3.org/2000/svg">
            ...
            {project.competitions.map((competition: awardProjectCompetitionSchemaType, index: number) => (
              <li key={index} className="list li-item  items-center text-gray-800 dark:text-neutral-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-flex">
                  <path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526" fill="#FFFF00" />
                  <circle cx="12" cy="8" r="6" fill="#FFFF00" />
                </svg>
